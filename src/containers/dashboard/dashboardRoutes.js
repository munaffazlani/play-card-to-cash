...
const routes = [
  {
    path: "",
    component: lazy(() => import("@app/components/stepsCard")),
    exact: true,
  },
  // {
  //   path: "inbox",
  ...
  // {
  //   path: "interpreters",
  //   component: lazy(() => import("@iso/containers/Interpreters/Interpreters")),
  // },
  // {
  //   path: "plans",
  //   component: lazy(() => import("@iso/containers/Plans/Plans")),
  // },
  // {
  //   path: "alert",
  ...
  // },
  {
    path: "changePassword",
    component: lazy(() =>
      import("@app/containers/Pages/ChangePassword/ChangePassword")
    ),
  },
];
